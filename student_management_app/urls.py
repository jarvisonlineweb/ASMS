...
urlpatterns = [
    ...
    path('fees_data/', HodViews.fees_data, name='fees_data'),
    path('fees_data_fatch/', HodViews.fees_data_fatch, name="fees_data_fatch"),
    ...
    path('student_view_fees_pay/', StudentViews.student_view_fees_pay, name="student_view_fees_pay"),
    # path('payment_conform/', StudentViews.payment_conform, name="payment_conform"),
    path("execute_payment/", StudentViews.execute_payment, name="execute_payment"),
    path("after_execute_payment/", StudentViews.after_execute_payment, name="after_execute_payment"),
    path("cancel_payment/", StudentViews.cancel_payment, name="cancel_payment"),
    path("Invoice/", StudentViews.Invoice, name="Invoice")
